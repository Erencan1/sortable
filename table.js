 ...
 *
    ...
    stage({
        'table_id': 'tableID',
        'row_counter': 10,
        //'nofTotalRows': 1000, used for ajax request yet it has not been implemented
        ...
        for (var r=0; r<header.rows.length; r++)
        {
            ...
            for (var c=0; c<row.cells.length; c++)
            {
                ...
                cell.onclick = function () {
                    // when header is clicked, sort by header's column
                    // can be added reverse sort when re-click
                    // below sort by this header's column
                    // replace null with a function to sort differently 
